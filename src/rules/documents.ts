...
export const DOCUMENT_TYPES: DocumentType[] = [
  ...
  },
  {
    ...
    name: 'Self-assessment tax document (strong, 100 points)',
    category: 'residence-proof',
    whyNeeded: 'For self-employed people. The tax office record of what you earned in that year, with your name and address on it.',
    isResidenceProof: true,
    points: 100,
    originalOrCopy: 'Certified copy. Get the tax calculation (SA302) and the tax year overview from your HMRC account for each year.',
    ...
    acceptanceCriteria: [
      NAME, ADDRESS, DATED_IN_PERIOD,
      kw('self-tax', 'It is a tax office record for a tax year', ['hmrc', 'self assessment', 'self-assessment', 'sa302', 'tax calculation', 'tax year overview', 'unique taxpayer reference', 'utr', 'revenue'],
        'An HMRC tax calculation, a tax year overview, or an Irish Revenue statement.'),
    ],
  },
  {
