...
export const DOCUMENT_TYPES: DocumentType[] = [
  ...
  },
  {
    ...
    category: 'residence-proof',
    whyNeeded: 'For employed people. Shows you worked and were taxed while living here for that tax year. If you are self-employed, use the self-assessment document instead.',
    isResidenceProof: true,
    points: 100,
  ...
  {
    docId: 'self-assessment',
    name: 'Self-assessment tax return or tax year record (strong, 100 points)',
    category: 'residence-proof',
    whyNeeded: 'For self-employed people. The tax office record for a tax year. Pick the version that carries your address. The printed view of your filed return and the SA100 form both show it. An SA302 tax calculation does not, so it fails the address test and cannot be your proof for a year.',
    isResidenceProof: true,
    points: 100,
    originalOrCopy: 'Certified copy. Download the full view of your filed return for each year from your HMRC account. Check your address is printed on it before you use it.',
    niNote: 'The strong list says "Employment Detail Summary (P60) or Revenue Statement". Revenue is the Irish tax office, and the Department never writes HMRC. A self-assessment document is the same kind of record, so it belongs here rather than in the 50 point box, but nobody has confirmed it. Ask the Citizenship Division before you rely on it. Remember a UK tax year runs from 6 April to 5 April, so it will rarely line up neatly with one of your residence years.',
    acceptanceCriteria: [
      NAME, ADDRESS, DATED_IN_PERIOD,
      kw('self-tax', 'It is a tax office record for a tax year', ['hmrc', 'hm revenue', 'self assessment', 'self-assessment', 'sa100', 'sa302', 'tax calculation', 'tax year overview', 'tax return', 'unique taxpayer reference', 'utr', 'revenue'],
        'An HMRC tax calculation, a tax year overview, a filed return, or an Irish Revenue statement.'),
      {
        id: 'not-a-draft-copy',
        label: 'It is not marked as a copy or a draft',
        hint: 'A page stamped "copy only" or "do not send" is something you filled in, not a record the tax office issued.',
        autoTest: {
          kind: 'lacksAnyKeyword',
          keywords: [
            'do not send to hmrc', 'do not send to hm revenue', 'for your records only',
            'copy only', 'draft', 'specimen', 'not for submission',
          ],
          warning: 'This is marked as a copy for your records. It still shows your name, address and tax year, so it can work, but expect a caseworker to see it as a print of your own return rather than a record the tax office issued.',
        },
      },
    ],
  },
  {
    docId: 'tax-submission-receipt',
    name: 'Self-assessment submission receipt (supporting, 50 points)',
    category: 'residence-proof',
    whyNeeded: 'The confirmation the tax office sends when your return goes in. It backs up your tax return, but it usually has no address on it, so it cannot stand alone.',
    isResidenceProof: true,
    points: 50,
    originalOrCopy: 'Certified copy. Send it alongside the tax return or the SA302, never on its own.',
    niNote: 'Watch the dates. The receipt is dated when you filed, which is often months after the tax year it is about.',
    acceptanceCriteria: [
      NAME, ADDRESS, DATED_IN_PERIOD,
      kw('receipt', 'It is a submission receipt', ['submission receipt', 'successfully submitted', 'receipt reference', 'self assessment', 'hmrc'],
        'The confirmation page from your self-assessment filing.'),
    ],
  },
  {
    ...
    category: 'residence-proof',
    whyNeeded: 'For employed people. Confirms the exact dates you worked here. This one works the same in Northern Ireland as in the Republic. It is not available to you if you are self-employed.',
    isResidenceProof: true,
    points: 100,
