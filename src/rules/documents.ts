...
export const DOCUMENT_TYPES: DocumentType[] = [
  ...
  },
  {
    ...
    name: 'Self-assessment tax document: SA302, tax year overview or tax return (strong, 100 points)',
    category: 'residence-proof',
    whyNeeded: 'For self-employed people. The tax office record for a tax year, with your name and your address on it. Best of all is the SA302 tax calculation together with the tax year overview, because HMRC issues those. A copy of the return you filled in is weaker.',
    isResidenceProof: true,
    points: 100,
    originalOrCopy: 'Certified copy. Download the tax calculation (SA302) and the tax year overview for each year from your HMRC account.',
    ...
    acceptanceCriteria: [
        ...
        'An HMRC tax calculation, a tax year overview, a filed return, or an Irish Revenue statement.'),
      {
        ...
        autoTest: {
          ...
          warning: 'This looks like a copy or a draft, not a document the tax office issued. Download your SA302 tax calculation and tax year overview instead.',
        },
      },
    ],
  },
